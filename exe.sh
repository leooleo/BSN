...
# ${terminal_name} -e ./odv/sensornode/collector/build/DataCollectorApp --cid=111 --id=0 &
# ${terminal_name} -e ./odv/sensornode/collector/build/DataCollectorApp --cid=111 --id=1 &
